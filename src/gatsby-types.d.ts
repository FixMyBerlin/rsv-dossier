...
type SteckbriefQuery = { readonly geometry: { readonly type: string | null, readonly bbox: ReadonlyArray<number | null> | null, readonly id: string | null, readonly features: ReadonlyArray<{ readonly type: string | null, readonly bbox: ReadonlyArray<number | null> | null, readonly geometry: { readonly coordinates: ReadonlyArray<ReadonlyArray<ReadonlyArray<number | null> | null> | null> | null, readonly type: string | null } | null, readonly properties: { readonly variant: string | null, readonly state: string | null, readonly planning_phase: string | null, readonly length: number | null, readonly id_rsv: string | null, readonly id: string | null, readonly detail_level: string | null, readonly discarded: boolean | null } | null } | null> | null } | null, readonly meta: {
  stakeholders: any; readonly cost: string | null, readonly state: string | null, readonly general: { readonly description: string | null, readonly name: string | null, readonly ref: string | null, readonly source: string | null, readonly length: number | null, readonly from: { readonly city: string | null, readonly federalState: string | null } | null, readonly to: { readonly city: string | null, readonly federalState: string | null } | null } | null, readonly references: { readonly website: string | null } | null, readonly staticMap: { readonly publicURL: string | null, readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null }
} | null };
